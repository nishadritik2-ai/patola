...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `services`(`id`, `servicename`, `description`,`img`) VALUES ('$category','$name','$des','$fileurl')";

    // $sql = "INSERT INTO `blog`(`category-id`, `name`, `slug`, `img`, `des`,) VALUES ('$category','$name','$slug','$fileurl','$des')";
    $result = mysqli_query($con, $sql);
    if (move_uploaded_file($tmpname, $folder . $file)) {
        // echo "data insert sucessfully";
    } else echo "."; ?>
    <script>
        alert('Service Added. Thank you<?php " . $name . " ?>');
        ...
        <div class="container">
            <form method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input name="servicename" type="text" placeholder="Enter product Name" class="form-control" id="exampleInputname">
                </div>
